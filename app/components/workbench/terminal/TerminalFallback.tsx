  ...
  return (
    <div className="h-full flex items-center justify-center bg-bolt-elements-terminals-background">
      <div className="text-center p-8 max-w-md">
        ...
        <h3 className="text-lg font-semibold text-bolt-elements-textPrimary mb-2">Terminal Não Disponível</h3>
        ...
        <div className="space-y-2">
          ...
          <div className="mt-4 p-3 bg-bolt-elements-background-depth-2 rounded text-xs">
            <strong className="text-bolt-elements-textSecondary">Alternativas:</strong>
