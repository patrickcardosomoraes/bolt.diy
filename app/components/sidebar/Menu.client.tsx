        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg px-4 py-3 transition-all duration-200 font-medium text-sm"
              >
              ...
              <button
                ...
                aria-label={selectionMode ? 'Sair do modo seleção' : 'Entrar no modo seleção'}
              >
            ...
            <div className="relative w-full">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 z-10">
                <span className="i-ph:magnifying-glass h-5 w-5 text-bolt-elements-icon-tertiary" />
              </div>
              <input
                className="w-full bg-bolt-elements-bg-depth-2 border border-bolt-elements-borderColor rounded-lg pl-10 pr-4 py-2.5 text-sm text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all duration-200"
                type="search"
                  ...
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <p className="mt-2">Tem certeza que deseja excluir este chat?</p>
                      </DialogDescription>
                    </div>
                  ...
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <p className="mt-3">Tem certeza que deseja excluir estes chats?</p>
                      </DialogDescription>
                    </div>
                    <div className="flex justify-end gap-3 px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
                      <DialogButton type="secondary" onClick={closeDialog}>
